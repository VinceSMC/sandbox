...
Each file defines one effect. Timeline stages can override its default source text to display different words or messages.
...
<br>When disabled, its placeholder returns the resolved source text without applying the configured effect.
...
<br>The value can be overridden by a timeline stage.
