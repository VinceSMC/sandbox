...
<br>At least two valid legacy or hexadecimal colors must be configured.
...
interpolation: TEXT
```
> *Supported values:* `rgb`, `hsv`  
> *Default value:* `rgb`

Sets the color space used to interpolate between the configured colors.
